...
import com.example.tasktable.DTO.ErrorDetalles;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(TaskPageException.class)
    public ResponseEntity<ErrorDetalles>manejarTaskPageException(TaskPageException exception,WebRequest webRequest){
        ErrorDetalles errorDetalles=new ErrorDetalles(new Date(),exception.getMessage(),webRequest.getDescription(false));
